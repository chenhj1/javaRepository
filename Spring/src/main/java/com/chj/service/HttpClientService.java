...
import com.chj.bean.HttpResult;
...
public class HttpClientService {
     ...
     * @return
     */
    public HttpResult doPostFile(MultipartFile file, Map<String, String> paramsMap, String remoteUrl) throws IOException {
        String result = "";
     ...
     * @throws IOException
     */
    public HttpResult doPostFile(MultipartFile file, String remoteUrl)throws IOException{
        return this.doPostFile(file,new HashMap<String, String>(),remoteUrl);
    }
